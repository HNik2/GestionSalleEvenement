    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header"><fmt:message code="common.parametrage.categorie" /></h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                ...
                <div class="row">
					<div class="col-lg-12">
						<ol class="breadcrumb">
						  <li><a href="<c:url value="/categorie/nouveau" />" ><i class="fa fa-plus">&nbsp;<fmt:message code="common.ajouter" /></i></a></li>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <fmt:message code="categorie.liste" />
                        </div>
                        <!-- /.panel-heading -->
                                ...
                                <tbody>
                                	<c:forEach items="${categories }" var = "cat">
	                                    <tr class="odd gradeX">
	                                        ...
	                                        <td>
	                                        	<c:url value="/categorie/modifier/${cat.getIdCategorie() }" var="urlModif" />
	                                        	<a href="${urlModif }"><i class="fa fa-edit"></i></a>
	                                        	&nbsp;|&nbsp;
	                                        	<a href="javascript:void(0);" data-toggle="modal" data-target="#modalCategory${cat.getIdCategorie() }"><i class="fa fa-trash-o"></i></a>
	                                        	<div class="modal fade" id="modalCategory${cat.getIdCategorie() }" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
													<div class="modal-dialog">
														<div class="modal-content">
															...
															<div class="modal-body">
																<fmt:message code="categorie.confirm.suppression.msg" />
															</div>
															<div class="modal-footer">
																<button type="button" class="btn btn-default" data-dismiss="modal"><fmt:message code="common.annuler" /></button>
																<c:url value="/categorie/supprimer/${cat.getIdCategorie() }" var="urlSuppression" />
