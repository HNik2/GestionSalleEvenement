                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                <thead>
                                    <tr>
                                        ...
                                        <th><fmt:message code="common.ville" /></th>
                                        <th><fmt:message code="common.mail" /></th>
                                        <th><fmt:message code="common.parametrage.type" /></th>
                                	...
                                	<c:forEach items="${clients }" var = "client">
	                                    <tr class="odd gradeX">
	                                       <td class="center"><img src="${client.getPhoto() }" width="50px" height="50px"/></td>
	                                        ...
	                                        <td >${client.getVilleClt().getNomVille() }</td>
	                                        <td>${client.getEmail() }</td>
	                                        <td >${client.getType().getDesignation() }</td>
	                                        <td>
