    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header"><fmt:message code="common.parametrage.ville" /></h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                ...
                <div class="row">
					<div class="col-lg-12">
						<ol class="breadcrumb">
						  <li><a href="<c:url value="/ville/nouveau" />" ><i class="fa fa-plus">&nbsp;<fmt:message code="common.ajouter" /></i></a></li>
                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                	<c:forEach items="${villes }" var = "cat">
	                                    <tr class="odd gradeX">
	                                       
	                                        <td>${cat.getNomVille() }</td>
	                                        <td>
	                                        	<c:url value="/ville/modifier/${cat.getIdVille() }" var="urlModif" />
	                                        	<a href="${urlModif }"><i class="fa fa-edit"></i></a>
	                                        	&nbsp;|&nbsp;
	                                        	<a href="javascript:void(0);" data-toggle="modal" data-target="#modalClient${cat.getIdVille() }"><i class="fa fa-trash-o"></i></a>
	                                        	<div class="modal fade" id="modalClient${cat.getIdVille() }" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
													<div class="modal-dialog">
														<div class="modal-content">
															...
															<div class="modal-footer">
																...
																<c:url value="/ville/supprimer/${cat.getIdVille() }" var="urlSuppression" />
