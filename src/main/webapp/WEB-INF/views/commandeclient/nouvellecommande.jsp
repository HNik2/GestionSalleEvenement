    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="alert alert-danger" id="notFoundMsgBlock">
               <fmt:message code="commande.client.salle.not.found" />
            </div>
							...
							<form action="" enctype="multipart/form-data" role = "form">
								<div class="form-row">
									<div class="col-md-4 mb-3">
	                                    ...
	                                    <input class="form-control" placeholder="Code" id="code" value = "${code }"  disabled/>
	                                </div>
									<div class="col-md-4 mb-3">
	                                    <label><fmt:message code="common.date" /></label>
	                                    <input class="form-control" placeholder="Date" id="dateReservation" value = "${dateCde }" disabled />
	                                </div>
									<div class="col-md-4 mb-3">
                ...
                <div class="col-lg-12">
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                        	<div class="form-row">
		                        <div class="col-md-4 mb-3">
		                        	<label><fmt:message code="common.salle" /></label>
		                        	<input class="form-control" type = "text" id="codeArticle_search" placeholder="Saisir un code de salle" />
		                        </div>
                        	</div>
                        	<br /><br /><br /><br />
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                <thead>
                                    <tr>
                                        <th><fmt:message code="common.salle" /></th>
