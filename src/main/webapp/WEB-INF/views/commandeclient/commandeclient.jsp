                                ...
                                <tbody>
                                	<c:forEach items="${commandesClient }" var = "cde">
                                		<tr>
	                                		...
	                                		<td>${cde.getDateReservation() }</td>
	                                		<td>${cde.getHeureEvenement()}</td>
	                                		<td>${cde.getHeureFinEvenement()}</td>
	                                		<td>${cde.getSalle2().getPrix() }</td>
	                               			<td>
	                               				<textArea id = "json${cde.getIdReservation() }" style="display: none;">${cde.getLigneCommandeJson() }  </textArea>
	                                        	<button class="btn btn-link" onclick="updateDetailCommande(${cde.getIdReservation() });"><i class="fa fa-th-list"></i></button>
	                                        	&nbsp;|&nbsp;
	                                        	<c:url value="/commandeclient/modifier/${cde.getIdReservation() }" var="urlModif" />
	                                        	<a href="${urlModif }"><i class="fa fa-edit"></i></a>
	                                        	&nbsp;|&nbsp;
	                                        	<a href="javascript:void(0);" data-toggle="modal" data-target="#modalcommande${cde.getIdReservation() }"><i class="fa fa-trash-o"></i></a>
	                                        	<div class="modal fade" id="modalcommande${cde.getIdReservation() }" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
													<div class="modal-dialog">
														<div class="modal-content">
															...
															<div class="modal-footer">
																...
																<c:url value="/commandeclient/supprimer/${cde.getIdReservation() }" var="urlSuppression" />
